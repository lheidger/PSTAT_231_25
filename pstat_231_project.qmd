...
final_knn_test <- fit(final_knn_wflow, data = osm_census_test)

pred_knn_test <- final_knn_test %>% 
...
Of the four models evaluated, the k-nearest neighbors model performed the best, with an accuracy of \[ACCURACY\] on the testing data.
