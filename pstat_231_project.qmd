...
Decided to remove `pct_hispanic` and `educ_college_perc` since they have correlation coefficients above 0.7.
...
Removing those two predictors eliminated the main correlation issues.
